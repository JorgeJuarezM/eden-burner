...
class JDFGenerator:
    ...
    def create_burn_job_jdf(self, iso_path: str, job_id: str = None,
                           burn_speed: str = None, verify: bool = None,
                           copies: int = 1) -> str:
        ...
        try:
            ...
            burning_params = self._create_burning_parameters(resource_pool, burn_speed, verify, copies)

            # Add process
            process = self._create_burning_process(jdf_root, component_resource, digital_asset, burning_params)
    ...
    def _create_digital_asset_resource(self, resource_pool: ET.Element, iso_path: str) -> ET.Element:
    ...
    def _create_burning_parameters(self, resource_pool: ET.Element, burn_speed: str,
                                  verify: bool, copies: int) -> ET.Element:
    ...
    def _create_burning_process(self, jdf_root: ET.Element, component: ET.Element,
                               digital_asset: ET.Element, burning_params: ET.Element) -> ET.Element:
